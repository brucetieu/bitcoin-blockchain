...
type Transaction struct {
	...
	// InputID string 
	// OutputID string 
	Inputs  []TxnInput `json:"txnInputs" gorm:"foreignKey:CurrTxnID;association_foreignkey:ID;PRELOAD:false"`
	Outputs []TxnOutput `json:"txnOutputs" gorm:"foreignKey:CurrTxnID;association_foreignkey:ID;PRELOAD:false"`
}
