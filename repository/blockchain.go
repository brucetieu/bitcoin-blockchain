...
func (repo *blockchainRepository) GetBlockchain() ([]reps.Block, error) {
	...
	for i := 0; i < len(blocks); i++ {
		...
		// Get the transactions for each block
...
func (repo *blockchainRepository) GetWallet(address string) (reps.Wallet, error) {
